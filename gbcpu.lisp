...
(setf (aref ops #x34) (make-instruction
                        ...
                        :fun (lambda (cpu instr)
                               (setf
                                 ...
                                 (incr-reg cpu #'get-byte-from-hl-address))
                               (incr-cpu-counters cpu instr))))
...
(setf (aref cb-ops #x06) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (write-memory-at-addr addr (rot-left-c-reg cpu (read-memory-at-addr addr)))
                                    (incr-cpu-counters cpu instr)))))
...
(setf (aref cb-ops #x0e) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (write-memory-at-addr addr (rot-right-c-reg cpu (read-memory-at-addr addr)))
                                    (incr-cpu-counters cpu instr)))))
...
(setf (aref cb-ops #x16) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (write-memory-at-addr addr (rot-left-reg cpu (read-memory-at-addr addr)))
                                    (incr-cpu-counters cpu instr)))))
...
(setf (aref cb-ops #x1e) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (write-memory-at-addr addr (rot-right-reg cpu (read-memory-at-addr addr)))
                                    (incr-cpu-counters cpu instr)))))
...
(setf (aref cb-ops #x26) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (write-memory-at-addr addr (sla cpu (read-memory-at-addr addr)))
                                    (incr-cpu-counters cpu instr)))))
...
(setf (aref cb-ops #x2e) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (write-memory-at-addr addr (sra cpu (read-memory-at-addr addr)))
                                    (incr-cpu-counters cpu instr)))))
...
(setf (aref cb-ops #x36) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (write-memory-at-addr addr (swap-reg cpu (read-memory-at-addr addr)))
                                    (incr-cpu-counters cpu instr)))))
...
(setf (aref cb-ops #x3e) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (write-memory-at-addr addr (srl cpu (read-memory-at-addr addr)))
                                    (incr-cpu-counters cpu instr)))))
...
(setf (aref cb-ops #x46) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (test-bit-reg cpu (read-memory-at-addr addr) 0)))))
...
(setf (aref cb-ops #x4e) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (test-bit-reg cpu (read-memory-at-addr addr) 1)))))
...
(setf (aref cb-ops #x56) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (test-bit-reg cpu (read-memory-at-addr addr) 2)))))
...
(setf (aref cb-ops #x5e) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (test-bit-reg cpu (read-memory-at-addr addr) 3)))))
...
(setf (aref cb-ops #x66) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (test-bit-reg cpu (read-memory-at-addr addr) 4)))))
...
(setf (aref cb-ops #x6e) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (test-bit-reg cpu (read-memory-at-addr addr) 5)))))
...
(setf (aref cb-ops #x76) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (test-bit-reg cpu (read-memory-at-addr addr) 6)))))
...
(setf (aref cb-ops #x7e) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (test-bit-reg cpu (read-memory-at-addr addr) 7)))))
...
(setf (aref cb-ops #x86) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (reset-bit-reg cpu (read-memory-at-addr addr) 0))))))
...
(setf (aref cb-ops #x8e) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (reset-bit-reg cpu (read-memory-at-addr addr) 1))))))
...
(setf (aref cb-ops #x96) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (reset-bit-reg cpu (read-memory-at-addr addr) 2))))))
...
(setf (aref cb-ops #x9e) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (reset-bit-reg cpu (read-memory-at-addr addr) 3))))))
...
(setf (aref cb-ops #xa6) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (reset-bit-reg cpu (read-memory-at-addr addr) 4))))))
...
(setf (aref cb-ops #xae) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (reset-bit-reg cpu (read-memory-at-addr addr) 5))))))
...
(setf (aref cb-ops #xb6) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (reset-bit-reg cpu (read-memory-at-addr addr) 6))))))
...
(setf (aref cb-ops #xbe) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (reset-bit-reg cpu (read-memory-at-addr addr) 7))))))
...
(setf (aref cb-ops #xc6) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (set-bit-reg cpu (read-memory-at-addr addr) 0))))))
...
(setf (aref cb-ops #xce) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (set-bit-reg cpu (read-memory-at-addr addr) 1))))))
...
(setf (aref cb-ops #xd6) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (set-bit-reg cpu (read-memory-at-addr addr) 2))))))
...
(setf (aref cb-ops #xde) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (set-bit-reg cpu (read-memory-at-addr addr) 3))))))
...
(setf (aref cb-ops #xe6) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (set-bit-reg cpu (read-memory-at-addr addr) 4))))))
...
(setf (aref cb-ops #xee) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (set-bit-reg cpu (read-memory-at-addr addr) 5))))))
...
(setf (aref cb-ops #xf6) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (set-bit-reg cpu (read-memory-at-addr addr) 6))))))
...
(setf (aref cb-ops #xfe) (make-instruction
                           ...
                           :fun (lambda (cpu instr)
                                  (let ((addr (get-address-from-reg-pair (gbcpu-h cpu) (gbcpu-l cpu))))
                                    (incr-cpu-counters cpu instr)
                                    (write-memory-at-addr addr (set-bit-reg cpu (read-memory-at-addr addr) 7))))))
